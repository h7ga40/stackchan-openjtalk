...
public:
     ...
     * @brief
     *
     * @return uitk_intl::Vector2i
     */
    virtual uitk_intl::Vector2i getAngleLimit() const
    {
        return _angle_limit;
    }
...
protected:
    ...
    void set_angle_limit(uitk_intl::Vector2i angleLimit)
    {
...
protected:
    uitk_intl::Vector2i _angle_limit;
    uitk_intl::AnimateValue _angle_anim;
    ...
    uitk_intl::SpringOptions_t map_speed_to_spring_options(int speed);
};
